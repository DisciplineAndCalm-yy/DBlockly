...
//luokailiang
Blockly.HTE_PINMODE = 'pinMode';
Blockly.HTE_PINMODEIN = 'INPUT';
Blockly.HTE_PINMODEOUT = 'OUTPUT';
Blockly.HTE_PINMODEPULLUP = 'INPUT_PULLUP';
Blockly.HTE_DECLARE='Declare';
Blockly.HTE_AS='as';
Blockly.HTE_VALUE='value';
Blockly.HTE_VALUE2='value';
Blockly.HTE_MAP='Map ';
Blockly.HTE_MAP_FROM="from [";
Blockly.HTE_MAP_TO="] to [";
Blockly.HTE_MILLIS='millis';
Blockly.HTE_DELAY='Delay';
Blockly.HTE_ATTACHINTERRUPT_PIN='attachInterrupt pin#';
Blockly.HTE_DETACHINTERRUPT_PIN = 'detachInterrupt pin#';
Blockly.HTE_ATTACHPININTERRUPT_PIN = 'attachPinInterrupt pin#';
Blockly.HTE_DETACHPININTERRUPT_PIN = 'detachPinInterrupt pin#';
Blockly.HTE_MODE='mode';
Blockly.HTE_DO='do';
Blockly.HTE_BUILDIN_LED='Build-in LED ';
Blockly.HTE_STAT='Stat';
Blockly.HTE_DIGITALWRITE_PIN='DigitalWrite PIN#';
Blockly.HTE_DIGITALREAD_PIN='DigitalRead PIN#';
Blockly.HTE_ANALOGWRITE_PIN='AnalogWrite PIN#';
Blockly.HTE_ANALOGREAD_PIN='AnalogRead PIN#';
Blockly.HTE_SERIAL_WRITE = 'write';
Blockly.HTE_SERIAL_PRINT = 'print';
Blockly.HTE_SERIAL_PRINTLN='println';
Blockly.HTE_SERIAL_PRINT_HEX='println(hex)';
Blockly.HTE_SERIAL_FLUSH='flush';
Blockly.HTE_STEP='step';
Blockly.HTE_TONE_PIN='Tone PIN#';
Blockly.HTE_FREQUENCY='frequency';
Blockly.HTE_DURATION='duration';
Blockly.HTE_NOTONE_PIN='noTone PIN#';
Blockly.HTE_BLOCKGROUP_CATEGORY='BlockGroup';
Blockly.HTE_IR_RECEIVE='IRreceive PIN#';
Blockly.HTE_IR_RECEIVE_ENABLE='enableIRIn PIN#';
Blockly.HTE_IR_SEND_NEC1='IRsend'
Blockly.HTE_IR_SEND_NEC2=' PIN#'
Blockly.HTE_IR_RECEIVE_RAW='IRreceive(Print RAW Data) PIN#';
Blockly.HTE_IR_SEND_RAW='IRsend(RAW) PIN#'
...
Blockly.HTE_PIN='PIN#';
Blockly.HTE_DEGREE_0_180='Degree (0~180)';
Blockly.HTE_READ_DEGREES='Read Degrees';
Blockly.HTE_HIGH='HIGH';
Blockly.HTE_LOW='LOW';
Blockly.HTE_ON='ON';
Blockly.HTE_OFF='OFF';
Blockly.HTE_RISING='RISING';
Blockly.HTE_FALLING='FALLING';
Blockly.HTE_CHANGE='CHANGE';
Blockly.HTE_I2C_MASTER_WRITE="I2C_Write device";
Blockly.HTE_I2C_MASTER_READ="I2C_Read device";
Blockly.HTE_I2C_MASTER_READ2="I2C_Read";
Blockly.HTE_I2C_VALUE="value"
...
Blockly.HTE_DF_BUZZER='Buzzer';
Blockly.HTE_DF_BTN='Button';
Blockly.HTE_DF_VIBRATION='Vibration';
Blockly.HTE_DF_TILT='Tilt';
Blockly.HTE_DF_TOUCH='Touch';
Blockly.HTE_DF_MAGNETIC='Magnetic';
Blockly.HTE_DF_PYROELECTRIC_INFRARED='Pyroelectric infrared';
Blockly.HTE_MB_PYROELECTRIC_INFRARED='PIR Motion';
Blockly.HTE_DF_JOYSTICK_D='Joystick button';
Blockly.HTE_DF_JOYSTICK_A='Joystick';
Blockly.HTE_JOYSTICK='Joystick';
Blockly.HTE_DF_POTENTIOMETER='Potentiometer';
Blockly.HTE_POTENTIOMETER='Potentiometer';
Blockly.HTE_DF_ROTATION='Rotation';
Blockly.HTE_DF_VOLTAGE='Voltage';
Blockly.HTE_DF_PIEZO_DISK_VIRBRATION='Piezo disk virbration';
Blockly.HTE_DF_SOUND='Sound';
Blockly.HTE_SOUND='Sound';
Blockly.HTE_DF_RELAY='Relay';
Blockly.HTE_DF_LIGHT='Light';
Blockly.HTE_DF_GRAYSCALE='Grayscale';
Blockly.HTE_DF_FLAME='Flame';
Blockly.HTE_DF_TEMPERATURE='Temperature';
Blockly.HTE_TEMPERATURE='Temperature(℃)';
Blockly.HTE_DF_ACCELEROMETER='Accelerometer';
Blockly.HTE_DF_MOISTURE='Moisture';
Blockly.HTE_DF_WATER='Water';
Blockly.HTE_DF_CO='Carbon monoxide';
Blockly.HTE_DF_SHARP_GP2Y0A21='Sharp GP2Y0A21';
Blockly.HTE_MAKELISTFROM='make list from text';
Blockly.HTE_SPLITBYDOU='';
Blockly.HTE_SETUP='setup';
Blockly.HTE_WARNING_INTERRUPT='This pin cannot be interrupted!';
Blockly.HTE_CHAOSHENGBO='Ultrasonic ranging(cm) ';
Blockly.HTE_MB_CHAOSHENGBO='Ultrasonic ranging';
Blockly.HTE_IR_RECEIVE_YES='Received';
Blockly.HTE_IR_RECEIVE_NO='NotReceived';
Blockly.LANG_VARIABLES_SET_TITLE='';
Blockly.HTE_TEXT_JOIN='join';
Blockly.HTE_SERIAL_AVAILABLE = 'isAvailable?';
...
Blockly.HTE_IR_RECIEVE_TOOLTIP='Do something when receiving infrared signals.';
Blockly.HTE_IR_SEND_NEC_TOOLTIP='Sends Infrared signals of the specified type';
Blockly.HTE_IR_RECIEVE_RAW_TOOLTIP='Print the Infrared signal in RAW type when receiving it.';
Blockly.HTE_IR_SEND_RAW_TOOLTIP='Sends RAW Infrared signals (set pin number, list, length of list and IR frequency)';
Blockly.HTE_LIST_NAME='list';
Blockly.HTE_LIST_LENGTH='listLength';
Blockly.HTE_TO_INT='toInt';
Blockly.HTE_TO_FLOAT='toFloat';
Blockly.HTE_DATA="data";
Blockly.HTE_BITS="bits";
Blockly.HTE_MB_LIGHT_GRAYSCALE='Light and Grayscale Sensor';
Blockly.HTE_MB_LIGHT_GRAYSCALE_LED=' LED set';
Blockly.HTE_MB_LIGHT_MOTOR='Set Motor';
Blockly.HTE_MB_LIGHT_MOTOR_SPEED=' Speed(-255~255)';
Blockly.HTE_DELAY_MS='ms';
Blockly.HTE_DELAY_US = 'μs';
Blockly.HTE_PIN = 'PIN#';
Blockly.HTE_GETTEMPERATUE = 'getTemperature';
Blockly.HTE_GETHUMIDITY = 'getHumidity';
Blockly.HTE_DHT11='DHT11 PIN#';
Blockly.HTE_DHT11_T='getTemperature';
Blockly.HTE_DHT11_H='getHumidity';
Blockly.HTE_LCD_RGB_BACKLIGHT='LCD RGB Backlight';
Blockly.HTE_DF_LCD='LCD';
Blockly.HTE_LCD_PRINT1='print line1';
Blockly.HTE_LCD_PRINT2='print line2';
Blockly.HTE_LCD_PRINT3='print line3';
Blockly.HTE_LCD_PRINT4='print line4';
Blockly.HTE_LCD_ROW='row';
Blockly.HTE_LCD_COLUMN='column';
Blockly.HTE_LCD_PRINT='print';
Blockly.HTE_LCD_SETCOLOR='setColor';
...
Blockly.HTE_LCD_STAT_CLEAR='Clear';
Blockly.HTE_LCD_NOBACKLIGHT = 'NoBackLight';
Blockly.HTE_LCD_BACKLIGHT = 'BackLight';

Blockly.HTE_7S_DISPLAY='7 Segment Display';
Blockly.HTE_NUMBER='number';
Blockly.HTE_BLUETOOTH='Bluetooth';
Blockly.HTE_BLUETOOTH_READ_STR='readString';
Blockly.HTE_AVAILABLE='available?';
Blockly.HTE_DATAPIN='dataPin#';
Blockly.HTE_CLOCKPIN='clockPin#';
Blockly.HTE_BITORDER='bitOrder';
Blockly.HTE_MSBFIRST='MSBFIRST';
Blockly.HTE_LSBFIRST='LSBFIRST';
Blockly.HTE_TOSTRING = 'toString';
Blockly.HTE_TOCHAR = 'toChar';
Blockly.HTE_TOASCII = 'toAscii';
Blockly.HTE_ROMEO_MOTOR='Romeo motor';
Blockly.HTE_ROMEO_MOTOR_SPEED='speed';
Blockly.HTE_STOP='stop';
Blockly.HTE_PULSEIN='pulseIn(μs) PIN#';
Blockly.HTE_PULSEIN_STAT='state';
Blockly.HTE_PULSEIN_TIMEOUT='timeout(μs)';
Blockly.HTE_SERIAL_READ_INT='parseInt';
Blockly.HTE_SERIAL_READ_FLOAT='parseFloat';
Blockly.HTE_MAX='max';
Blockly.HTE_MIN='min';
Blockly.HTE_WRITE_SD_FILE='Write SD File';
Blockly.HTE_SD_DATA='Data';
Blockly.HTE_SD_NEWLINE='NewLine';
Blockly.HTE_EEPROM_WRITE_LONG='Write(long) EEPROM address';
Blockly.HTE_EEPROM_READ_LONG='Read(long) EEPROM address';
Blockly.HTE_EEPROM_WRITE_BYTE='Write(byte) EEPROM address';
Blockly.HTE_EEPROM_READ_BYTE='Read(byte) EEPROM address';
Blockly.HTE_SENSE_MOTOR='Set Motor Speed(-255~255)';
Blockly.HTE_SENSE_MOTOR_STOP='Stop Motor';
Blockly.HTE_SENSE_SERVO='Set Servo Angle';
Blockly.HTE_SENSE_RGBLED='Set RGB LED\'s Color ';
Blockly.HTE_TRAFFIC_LED='Set Traffic LED';
Blockly.HTE_EAST='EAST';
Blockly.HTE_SOUTH='SOUTH';
Blockly.HTE_WEST='WEST';
Blockly.HTE_NORTH='NORTH';
Blockly.HTE_SENSE_BUZZER='Set Buzzer';
Blockly.HTE_SENSE_ULTRASONIC='Ultrasonic Value';
Blockly.HTE_SENSE_PYROELECTRIC_INFRARED='PIR Motion?';
Blockly.HTE_BUTTON='Button';
Blockly.HTE_UP='UP';
Blockly.HTE_DOWN='DOWN';
Blockly.HTE_LEFT='LEFT';
Blockly.HTE_RIGHT='RIGHT';
Blockly.HTE_MID='MID';
Blockly.HTE_IS_PRESSED='is pressed?';
Blockly.HTE_SENSE_SLIDING='Sliding Potentiometer Value';
Blockly.HTE_SENSE_TEMPERATURE='Temperature Value';
Blockly.HTE_SENSE_HUMIDITY='Humidity Value';
Blockly.HTE_SENSE_SOUND='Sound Value';
Blockly.HTE_SENSE_LIGHT='Light Value';
Blockly.HTE_SENSE_WEIGHT='Weight Value';
Blockly.HTE_SENSE_IR='IR Received:';
Blockly.HTE_SENSE_DIGITAL_DISPLAY='Set LED Digital Display(0~99)';
Blockly.HTE_SENSE_DIGITAL_DISPLAY_CLOSE='Close LED Digital Display';
Blockly.HTE_SENSE_LED_MATRIX='Set LED Matrix(0~9)';
Blockly.HTE_SENSE_LED_MATRIX_CLOSE='Close LED Matrix';
Blockly.LANG_INOUT_DIGITAL_WRITE_TOOLTIP='Write digital value to a specific Port';
Blockly.HTE_FORWARD='run forward';
Blockly.HTE_BACKWARD='run backward';
Blockly.HTE_TURNLEFT='turn left';
Blockly.HTE_TURNRIGHT='turn right';
Blockly.HTE_MBOT_SPEED='at speed(-255~255)';
Blockly.HTE_RUNTIME='System running time';
Blockly.HTE_LED_ON_BOARD='led on board';
Blockly.HTE_ALL='all';
Blockly.HTE_SET_LED='Set LED';
Blockly.HTE_MBOT_TONE='Play tone';
Blockly.HTE_MBOT_NOTONE='Stop tone';
Blockly.HTE_SHOW_FACE='Show face';
Blockly.HTE_SHOW_FACE_TEXT='characters:';
Blockly.HTE_SHOW_FACE_TIME='time';
Blockly.HTE_MBOT_SET_DISPLAY='Set 7-segments display';
Blockly.HTE_MBOT_SET_LIGHT='Set light sensor';
Blockly.HTE_MBOT_SET_LIGHT_LED='led as';
Blockly.HTE_MBOT_SET_CAMERA='Set camera shutter';
Blockly.HTE_MBOT_SET_CAMERA_STAT='as';
Blockly.HTE_MBOT_SET_CAMERA_PRESS='Press';
Blockly.HTE_MBOT_SET_CAMERA_RELEASE='Release';
Blockly.HTE_MBOT_SET_CAMERA_FOCUS_ON='Focus On';
Blockly.HTE_MBOT_SET_CAMERA_FOCUS_OFF='Focus Off';
Blockly.HTE_MBOT_LIGHT_SENSOR='Light sensor';
Blockly.HTE_LIGHT_SENSOR_ON_BOARD='light sensor on board';
Blockly.HTE_MBOT_BUTTON='Button';
Blockly.HTE_MBOT_BUTTON_PRESSED='pressed';
Blockly.HTE_MBOT_BUTTON_RELEASED='released';
Blockly.HTE_MBOT_LINE_FOLLOWER='Line follower';
Blockly.HTE_MBOT_JOYSTICK='Joystick';
Blockly.HTE_MBOT_JOYSTICK_X='X-Axis';
Blockly.HTE_MBOT_JOYSTICK_Y='Y-Axis';
Blockly.HTE_MBOT_POTENTIOMETER='Potentiometer';
Blockly.HTE_MBOT_SOUND_SENSOR='Sound sensor';
Blockly.HTE_MBOT_LIMIT_SWITCH='Limit switch';
Blockly.HTE_MBOT_TEMPERATURE='Temperature';
Blockly.HTE_MBOT_PIR_MOTION_SENSOR='Pir motion sensor';
Blockly.HTE_MBOT_IR_REMOTE='Ir remote';
Blockly.HTE_MBOT_IR_REMOTE_PRESSED='pressed';
Blockly.HTE_SETTING='setting';
Blockly.HTE_SEND_MBOT_MESSAGE='Send mBot\'s message';
Blockly.HTE_MBOT_MESSAGE_RECEIVED='mBot\'s message received';
Blockly.HTE_LABPLUS_ROBOT_MOVEMENT='Robot movement';
Blockly.HTE_LABPLUS_ROBOT_MOVEMENT_GO_FORWARD='go forward;'
Blockly.HTE_LABPLUS_ROBOT_MOVEMENT_STOP='stop';
Blockly.HTE_LABPLUS_ROBOT_MOVEMENT_GO_BACK='go back';
Blockly.HTE_LABPLUS_ROBOT='Robot';
Blockly.HTE_LABPLUS_ROBOT_TURN_LEFT='turn left';
Blockly.HTE_LABPLUS_ROBOT_TURN_RIGHT='turn right';
Blockly.HTE_LABPLUS_ROBOT_DISPLAY='Set led matrix to';
Blockly.HTE_LABPLUS_ROBOT_DISPLAY_SMILE='smile';
Blockly.HTE_LABPLUS_ROBOT_DISPLAY_NOSMILE='sad';
Blockly.HTE_LABPLUS_ROBOT_DISPLAY_CLOSE_EYE='close eyes';
Blockly.HTE_LABPLUS_ROBOT_DISPLAY_LEFT='left arrow';
Blockly.HTE_LABPLUS_ROBOT_DISPLAY_RIGHT='right arrow';
Blockly.HTE_LABPLUS_ROBOT_DISPLAY_TIAOWEN='stripe';
Blockly.HTE_LABPLUS_ROBOT_DISPLAY_ZEBRA='zebra';
Blockly.HTE_LABPLUS_ROBOT_DISPLAY_NOTHING='nothing';
Blockly.HTE_LABPLUS_ROBOT_LED_TOP='Set led on top to';
Blockly.HTE_LABPLUS_ROBOT_LED_SIDE='Set side leds\' color to';
Blockly.HTE_LCD_ADDRESS="address";
var MSG = {
  catInOut: "In/Out",
  catControl: "Control",
  catMath: "Math",
...
Blockly.HTE_TOOLTIP_INOUT_HIGHLOW='Returns high or low voltage.';
Blockly.HTE_TOOLTIP_INOUT_DIGITAL_READ='Returns digital value of a specific Port';
Blockly.HTE_TOOLTIP_INOUT_ANALOG_WRITE='Writes analog value between 0 and 255 to a specific Port';
Blockly.HTE_TOOLTIP_INOUT_ANALOG_READ='Returns value between 0 and 1023 of a specific Port';
Blockly.HTE_TOOLTIP_INOUT_ATTACHINTERRUPT='Attachs interrupt to a specific Port';
Blockly.HTE_TOOLTIP_INOUT_DETACHINTERRUPT='Detachs interrupt to a specific Port';
Blockly.HTE_TOOLTIP_CONTROL_SETUP='Initialization(run only once)';
Blockly.HTE_TOOLTIP_CONTROL_DELAY='Delays specific time';
Blockly.HTE_TOOLTIP_CONTROL_MILLIS='Returns the system running time';
Blockly.HTE_TOOLTIP_VARIABLES_DECLARE='Declare and initialize a variable';
Blockly.HTE_TOOLTIP_MATH_MAX='Returns the larger number';
Blockly.HTE_TOOLTIP_MATH_MIN='Returns the smaller number';
Blockly.HTE_TOOLTIP_MATH_MAP='Maps a number from the first interval to the second interval.';
Blockly.HTE_TOOLTIP_TEXT_JOIN='Creates a piece of text by joining together two piece of text.';
Blockly.HTE_TOOLTIP_TEXT_TOTEXT = 'Converts a number into a string.';
Blockly.HTE_TOOLTIP_TEXT_TOCHAR = 'Returns the char corresponding to an ASCII code.';
Blockly.HTE_TOOLTIP_TEXT_TOASCII = 'Returns the ASCII code corresponding to a char.';
Blockly.HTE_TOOLTIP_TEXT_TOINT='Converts a string into an integer.';
Blockly.HTE_TOOLTIP_TEXT_TOFLOAT='Converts a string into an float.';
Blockly.HTE_TOOLTIP_LISTS_CREATE_WITH_TEXT = "Creates a list from a text.";
Blockly.HTE_TOOLTIP_LOGIT_TRUEORFALSE='If the first number is true, the second number is returned, otherwise the third number.';
Blockly.HTE_TOOLTIP_BLOCKGROUP_SERIAL_AVAILABLE='If the serial port is available, it returns true, otherwise returns false.';
Blockly.HTE_TOOLTIP_BLOCKGROUP_SERIAL_READ_STR='Returns a string in serial port.';
Blockly.HTE_TOOLTIP_BLOCKGROUP_SERIAL_READ_INT='Returns a integer in serial port.';
Blockly.HTE_TOOLTIP_BLOCKGROUP_SERIAL_READ_FLOAT='Returns a float in serial port.';
Blockly.HTE_TOOLTIP_BLOCKGROUP_CHAOSHENGBO='Returns the distance of ultrasonic sensor measured.';
Blockly.HTE_TOOLTIP_BLOCKGROUP_GET_TEM='Returns the temperature of dht11 sensor measured.';
Blockly.HTE_TOOLTIP_BLOCKGROUP_GET_HUM = 'Returns the humidity of dht11 sensor measured.';
Blockly.HTE_TOOLTIP_BLOCKGROUP_SERVO_MOVE = 'Moves between 0~180 degree.';
Blockly.HTE_TOOLTIP_BLOCKGROUP_SERVO_READ = 'Returns that degree with the last servo move.';
Blockly.HTE_TOOLTIP_BLOCKGROUP_TONE = 'Play sound at the specified frequency.';
Blockly.HTE_TOOLTIP_BLOCKGROUP_TONE2 = 'Play sound according to the specified frequency and duration.';
Blockly.HTE_TOOLTIP_BLOCKGROUP_NOTONE = 'Stop playing sound.';
...
Blockly.HTE_SERIAL_BEGIN='baud rate';
...
//interrupts
Blockly.HTE_CONTROL_INTERRUPTS = 'interrupts';
Blockly.HTE_CONTROL_NOINTERRUPTS = 'nointerrupts';

//others
Blockly.HTE_WARNING_NOT_DECLARE='This variable is not declared!';
Blockly.HTE_LENGTH = "length of";
...
Blockly.HTE_CONTROL_END_PROGRAM = "end program";
...
// RGB
Blockly.HTE_RGB = 'RGB Light';
Blockly.HTE_RGB_NUM = 'Light number';
Blockly.HTE_RGB_COUNT = 'Light Count';
Blockly.HTE_RGB_R = 'R value';
Blockly.HTE_RGB_G = 'G value';
Blockly.HTE_RGB_B = 'B value';

//四位数码管
Blockly.HTE_4DIGITDISPLAY = 'Digitdisplay';
Blockly.HTE_4DIGITDISPLAY_DISPLAYSTRING = 'displayString';
Blockly.HTE_4DIGITDISPLAY_NOMBER1 = 'No.';
Blockly.HTE_4DIGITDISPLAY_NOMBER2 = '';
Blockly.HTE_4DIGITDISPLAY_DOT = 'Dot';
Blockly.HTE_4DIGITDISPLAY_ON = 'On';
Blockly.HTE_4DIGITDISPLAY_OFF = 'Off';

//TM1637
Blockly.HTE_4DIGITDISPLAY_TM1637 = 'TM1637';
Blockly.HTE_4DIGITDISPLAY_TM1637_DISPLAYSTRING = 'TM1637 Show(scroll) string';
Blockly.HTE_4DIGITDISPLAY_TM1637_DISPLAYSTRING_TIP = '';
Blockly.HTE_4DIGITDISPLAY_TM1637_TIP = '';
Blockly.HTE_4DIGITDISPLAY_TM1637_DISPLAYTIME = 'TM1637 Show time';
Blockly.HTE_4DIGITDISPLAY_TM1637_DISPLAYTIME_TOOLTIP = '';
Blockly.HTE_4DIGITDISPLAY_TM1637_INIT = 'TM1637 Init';
Blockly.HTE_4DIGITDISPLAY_STOPWATCH = 'Stopwatch';
Blockly.HTE_4DIGITDISPLAY_TM1637_STOPWATCH_TOOLTIP = '';
Blockly.HTE_4DIGITDISPLAY_STOPWATCH_START = 'Start';
Blockly.HTE_4DIGITDISPLAY_STOPWATCH_PAUSE = 'Pause';
Blockly.HTE_4DIGITDISPLAY_STOPWATCH_RESET = 'Reset';
Blockly.HTE_4DIGITDISPLAY_TM1637_BRIGHTNESS = 'TM1637 Brightness';
