...
Blockly.Blocks.texts.HUE = '#ef2140';
...
Blockly.Blocks['text_join'] = {
  init: function() {
    ...
    this.appendValueInput('B')
        .setCheck([String,Number])
        .appendField(Blockly.HTE_TEXT_JOIN);
...
Blockly.Blocks['text_to_number'] = {
  init: function() {
	var TO_INT_FLOAT =
        [[Blockly.HTE_TO_INT, 'toInt'],
        [Blockly.HTE_TO_FLOAT, 'toFloat']];
    this.setColour(Blockly.Blocks.texts.HUE);
    ...
    this.setTooltip(function() {
      ...
      var TOOLTIPS = {
        'toInt': Blockly.HTE_TOOLTIP_TEXT_TOINT,
        'toFloat': Blockly.HTE_TOOLTIP_TEXT_TOFLOAT
      };
...
Blockly.Blocks['ascii_to_char'] = {
  init: function() {
    ...
    this.appendValueInput('VAR')
        .setCheck(Number)
		.appendField(Blockly.HTE_TOCHAR);
	this.setOutput(true, String);
	this.setTooltip(Blockly.HTE_TOOLTIP_TEXT_TOCHAR);
  }
};
...
Blockly.Blocks['char_to_ascii'] = {
    init: function () {
        this.setColour(Blockly.Blocks.texts.HUE);
        this.appendDummyInput()
            .appendField(Blockly.HTE_TOASCII)
            .appendField("'")
            .appendField(new Blockly.FieldTextInput('',Blockly.FieldTextInput.char_validator), 'TEXT')
            .appendField("'");
        this.setOutput(true, Number);
        this.setTooltip(Blockly.HTE_TOOLTIP_TEXT_TOASCII);
    }
};
...
Blockly.Blocks['number_to_text'] = {
    init: function () {
        ...
        this.appendValueInput('VAR')
            .setCheck(Number)
            .appendField(Blockly.HTE_TOSTRING);;
        this.setOutput(true, String);
        this.setTooltip(Blockly.HTE_TOOLTIP_TEXT_TOTEXT);
    }
};
...
init: function() {
    this.setColour(Blockly.Blocks.texts.HUE);
	this.appendValueInput("VAR")
        .appendField(Blockly.HTE_LENGTH)
        .setCheck(String);
	this.setOutput(true, Number);
  }
}
...
init: function() {
	...
	this.appendValueInput("STR1")
        .setCheck(String);
	this.appendValueInput("STR2")
        .appendField(Blockly.HTE_COMPARETO)
        .setCheck(String);
	this.setOutput(true, Number);
	this.setInputsInline(true);
	this.setTooltip(Blockly.HTE_COMPARETO_HELP);
  }
}