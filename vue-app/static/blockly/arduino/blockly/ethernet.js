...
Blockly.Blocks['ethernet_init_begin'] = {
  init: function() {
    ...
    this.appendDummyInput()
        .appendField(Blockly.HTE_ETHERNET_BEGIN)
        .appendField(new Blockly.FieldDropdown([[Blockly.HTE_ETHERNET, 'Ethernet'],[Blockly.HTE_ETHERNET2,'Ethernet2']]), "Ethernet");
	  this.appendValueInput('MAC')
		    .setCheck(Array)
		    .setAlign(Blockly.ALIGN_RIGHT)
        .appendField(Blockly.HTE_ETHERNET_MAC_ADDRESS);
...
Blockly.Blocks['ethernet_init_local_ip'] = {
  init: function() {
    this.setColour(Blockly.Blocks.ethernet.HUE);
    this.appendDummyInput()
        .appendField(Blockly.HTE_ETHERNET_LOCALIP);
...
Blockly.Blocks['ethernet_client_connect_server']={
  init: function() {
    this.setColour(Blockly.Blocks.ethernet.HUE);
    this.appendDummyInput()
        .appendField(Blockly.HTE_ETHERNET_CLINET_CONNECT_SERVER)
	  ...
	  this.appendValueInput('PORT')
		    .setCheck(Number)
		    .setAlign(Blockly.ALIGN_RIGHT)
        .appendField(Blockly.HTE_ETHERNET_CLINET_PORT);
    this.setOutput(true, Number);
...
Blockly.Blocks['ethernet_client_stop'] = {
  init: function() {
    this.setColour(Blockly.Blocks.ethernet.HUE);
    this.appendDummyInput()
        .appendField(Blockly.HTE_ETHERNET_CLINET_STOP);
...
Blockly.Blocks['ethernet_client_connected'] = {
  init: function() {
    this.setColour(Blockly.Blocks.ethernet.HUE);
    this.appendDummyInput()
        .appendField(Blockly.HTE_ETHERNET_CLINET_CONNECTED);
    this.setOutput(true, Number);
  }
};
...
Blockly.Blocks['ethernet_client_available'] = {
  init: function() {
    this.setColour(Blockly.Blocks.ethernet.HUE);
    this.appendDummyInput()
        .appendField(Blockly.HTE_ETHERNET_CLINET_AVAILABLE);
    this.setOutput(true, Number);
  }
};
  ...
  init: function() {
    this.setColour(Blockly.Blocks.ethernet.HUE);
	  this.appendValueInput('TEXT')
		    .setCheck(String)
        .appendField(Blockly.HTE_ETHERNET_CLINET_PRINT);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setInputsInline(true);
  }
...
Blockly.Blocks['ethernet_client_println'] = {
  init: function() {
    this.setColour(Blockly.Blocks.ethernet.HUE);
	  this.appendValueInput('TEXT')
        .setCheck(String)
        .appendField(Blockly.HTE_ETHERNET_CLINET_PRINTLN);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setInputsInline(true);
  }
...
Blockly.Blocks['ethernet_client_read'] = {
  init: function() {
    this.setColour(Blockly.Blocks.ethernet.HUE);
    this.appendDummyInput()
        .appendField(Blockly.HTE_ETHERNET_CLINET_READ);
    this.setOutput(true, Number);
  }
};
...
Blockly.Blocks['ethernet_client_get_request']={
  init: function() {
    this.setColour(Blockly.Blocks.ethernet.HUE);
	  this.appendDummyInput()
        .appendField(Blockly.HTE_ETHERNET_CLINET_GET_REQUEST);
    this.appendDummyInput()
        .appendField(Blockly.HTE_ETHERNET_CLINET_URL)
		    .appendField(this.newQuote_(true))
        .appendField(new Blockly.FieldTextInput(''), 'URL')
        .appendField(this.newQuote_(false));
	  this.appendDummyInput()
        .appendField(Blockly.HTE_ETHERNET_CLINET_SERVER)
		    .appendField(this.newQuote_(true))
