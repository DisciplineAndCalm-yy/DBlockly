...
Blockly.Blocks.store_sd_write = {
  init: function() {
    ...
    this.appendValueInput("DATA", String)
        ...
        .appendField(Blockly.HTE_SD_DATA);
    this.appendValueInput("NEWLINE", Boolean)
        .setCheck(Boolean)
        .setAlign(Blockly.ALIGN_RIGHT)
        .appendField(Blockly.HTE_SD_NEWLINE);
...
Blockly.Blocks.store_eeprom_write_long = {
  init: function() {
    ...
    this.appendValueInput("ADDRESS", Number)
		.setCheck(Number)
        .appendField(Blockly.HTE_EEPROM_WRITE_LONG);
...
Blockly.Blocks.store_eeprom_read_long = {
  init: function() {
    ...
    this.appendValueInput("ADDRESS", Number)
		.setCheck(Number)
        .appendField(Blockly.HTE_EEPROM_READ_LONG);
...
Blockly.Blocks.store_eeprom_write_byte = {
  init: function() {
    ...
    this.appendValueInput("ADDRESS", Number)
		.setCheck(Number)
        .appendField(Blockly.HTE_EEPROM_WRITE_BYTE);
    this.appendValueInput("DATA", Number)
        .setCheck(Number)
        .setAlign(Blockly.ALIGN_RIGHT)
        .appendField(Blockly.HTE_DATA);
...
Blockly.Blocks.store_eeprom_read_byte = {
  init: function() {
    ...
    this.appendValueInput("ADDRESS", Number)
		.setCheck(Number)
        .appendField(Blockly.HTE_EEPROM_READ_BYTE);
    this.setOutput(true, Number);
  }
};
