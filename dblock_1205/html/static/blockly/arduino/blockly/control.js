...
Blockly.Blocks.loops.HUE = '#3D91FF';
  ...
  init: function() {
    ...
    this.appendDummyInput()
	  ...
	  this.appendStatementInput('DO')
        .appendField('');
	  this.setTooltip(Blockly.HTE_TOOLTIP_CONTROL_SETUP);
  }
};
...
Blockly.Blocks.base_delay = {
  init: function() {
	var UNIT =
    [[Blockly.HTE_DELAY_MS, 'delay'],
    [Blockly.HTE_DELAY_US, 'delayMicroseconds']];
    this.setColour(Blockly.Blocks.loops.HUE);
    this.appendValueInput("DELAY_TIME", Number)
        .appendField(Blockly.HTE_DELAY)
        .appendField(new Blockly.FieldDropdown(UNIT), 'UNIT')
        .setCheck(Number);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setInputsInline(true);
    this.setTooltip(Blockly.HTE_TOOLTIP_CONTROL_DELAY);
  }
};
...
Blockly.Blocks.controls_millis = {
  init: function() {
	var UNIT =
    [[Blockly.HTE_DELAY_MS, 'millis'],
		[Blockly.HTE_DELAY_US, 'micros']];
    this.setColour(Blockly.Blocks.loops.HUE);
    this.appendDummyInput()
	      .appendField(Blockly.HTE_RUNTIME)
        .appendField(new Blockly.FieldDropdown(UNIT), 'UNIT');
    this.setOutput(true, Number);
	  this.setTooltip(Blockly.HTE_TOOLTIP_CONTROL_MILLIS);
  }
};
...
Blockly.Blocks.controls_mstimer2 = {
  init: function() {
    ...
    this.appendValueInput('TIME')
        ...
        .appendField(Blockly.HTE_MSTIMER2_EVERY);
    this.appendDummyInput()
        .appendField('ms');
    this.appendStatementInput('DO')
        .appendField(Blockly.HTE_MSTIMER2_DO);
    this.setPreviousStatement(true);
    this.setNextStatement(true);
  }
};
...
Blockly.Blocks.controls_mstimer2_start = {
  init: function() {
    ...
    this.appendDummyInput()
      .appendField('MsTimer2')
      .appendField(Blockly.HTE_MSTIMER2_START);
    this.setPreviousStatement(true);
    this.setNextStatement(true);
  }
};
...
Blockly.Blocks.controls_mstimer2_stop = {
  init: function() {
    ...
    this.appendDummyInput()
      .appendField('MsTimer2')
      .appendField(Blockly.HTE_MSTIMER2_STOP);
    this.setPreviousStatement(true);
    this.setNextStatement(true);
  }
};
...
Blockly.Blocks.controls_end_program = {
  init: function() {
    this.setColour(Blockly.Blocks.loops.HUE);
    this.appendDummyInput()
	    .appendField(Blockly.HTE_CONTROL_END_PROGRAM);
	  this.setPreviousStatement(true);
    this.setNextStatement(true);
  }
};
...
Blockly.Blocks.controls_interrupts = {
    init: function () {
        this.setColour(Blockly.Blocks.loops.HUE);
        this.appendDummyInput()
            .appendField(Blockly.HTE_CONTROL_INTERRUPTS);
        this.setPreviousStatement(true);
        this.setNextStatement(true);
    }
};
...
Blockly.Blocks.controls_nointerrupts = {
    init: function () {
        this.setColour(Blockly.Blocks.loops.HUE);
        this.appendDummyInput()
            .appendField(Blockly.HTE_CONTROL_NOINTERRUPTS);
        this.setPreviousStatement(true);
        this.setNextStatement(true);
    }
};
