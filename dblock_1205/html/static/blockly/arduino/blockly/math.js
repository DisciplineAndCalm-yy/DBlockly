...
Blockly.Blocks.math.HUE = '#33aa00';
...
Blockly.Blocks['math_max_min']= {
  init: function() {
    ...
    this.setTooltip(function() {
      var mode = thisBlock.getFieldValue('OP');
      var TOOLTIPS = {
        'max': Blockly.HTE_TOOLTIP_MATH_MAX,
        'min': Blockly.HTE_TOOLTIP_MATH_MIN
      };
      return TOOLTIPS[mode];
    });
  }
...
Blockly.Blocks.base_map = {
  init: function() {
    ...
    this.setInputsInline(true);
    this.setOutput(true);
	this.setTooltip(Blockly.HTE_TOOLTIP_MATH_MAP);
  }
};